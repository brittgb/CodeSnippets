...
function limitText() {
	...
	// Find the last space before 75 characters:
	var lastSpace = originalText.lastIndexOf(' ', 75);
	...
	// Display the limitedText, in all caps:
	document.getElementById('result').value = limitedText.toUpperCase();
