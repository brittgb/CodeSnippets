...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	//test for either of the two password fields being empty, then if both complete check for two values matching
	...
	if (!$problem) { // If there weren't any problems...
		...
		// Send the email:
		$body = "Welcome to the JD Salinger fan club! If you received this message in error, please do not respond to it. Otherwise, click on www.fakelink.com to confirm your registration. 
		Your name is {$_POST['first_name']} {$_POST['last_name']}.
		Your password is '{$_POST['password1']}' and you registered at $date. See you on the website!";
